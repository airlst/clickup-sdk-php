...
class GetFilteredTeamTasks extends Request
{
	 ...
	 * @param null|array $spaceIds Filter by Spaces. For example: \
	 *  \
	 * `?space_ids[]=1234&space_ids[]=6789`
	 * @param null|array $projectIds Filter by Folders. For example: \
	 *  \
	 * `?project_ids[]=1234&project_ids[]=6789`
	 * @param null|array $listIds Filter by Lists. For example: \
	 *  \
	 * `?list_ids[]=1234&list_ids[]=6789`
	 * @param null|array $statuses Filter by statuses. Use `%20` to represent a space character. To include closed tasks, use the `include_closed` parameter. \
	 *  \
	 * For example: \
	 *  \
	 ...
	 * @param null|array $assignees Filter by Assignees using people's ClickUp user id. For example: \
	 *  \
	 * `?assignees[]=1234&assignees[]=5678`
	 * @param null|array $tags Filter by tags. User `%20` to represent a space character. For example: \
	 *  \
	 ...
	 * @param null|string $parent Include the parent task ID to return subtasks.
