...
class EditChecklistItem extends Request
{
	 ...
	 * @param null|mixed $assignee
	 * @param null|bool $resolved
	 * @param null|mixed $parent To nest a checklist item under another checklist item, include the other item's `checklist_item_id`.
	 */
